...
function EditBanner({bannerId , close}) {
  ...
  const handleSubmit = async (e) => {
    ...
    formData.append('titile', edit.titile)
    const config = {headers:{'Content-Type':'multipart/form-data'}}
    const response = await useAxiosInstance.put(`/banner/update/${bannerId}/`,formData, config)
    if(response.status === 200){
      ...
      Toast.fire({
        icon: "success",
        title: "Successfully Edited Banner"
      });
      close()
    }
        ...
        <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
          ...
          <form>
              ...
              <label className="block">
                ...
                onChange={(e) => {
                            if (e.target.files && e.target.files.length > 0) {
                                ...
                                setEdit((prevPost) => ({ ...prevPost, image: file }));
            ...
            <div className="relative">
              ...
              value={edit.titile}
                onChange={(e) => {
                  setEdit((prevPost) => ({ ...prevPost, titile: e.target.value }));
                }}
                type="text"
                id="input"
                name="input"
