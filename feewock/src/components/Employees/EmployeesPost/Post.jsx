...
function Post() {
  return (
   <EmployeeLoyouts>
          {/* <button
    className="rounded-lg relative w-36 h-10 cursor-pointer flex items-center border border-custom-blue bg-custom-blue group hover:bg-custom-blue active:bg-custom-blue active:border-custom-blue"
  >
    <span
