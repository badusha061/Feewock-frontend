...
function DeleteConformation({close , id}) {
  let BASE_URL = import.meta.env.VITE_REACT_APP_BASE_URL;
  const axiosInstance = useAxios()
  const handleDelete = async (e) => {
    const response = await axiosInstance.delete(`${BASE_URL}/post/update/${id}/`)
  ...
  return (
    ...
    <div onClick={close} className="w-full max-w-md bg-white shadow-lg rounded-md p-6 relative">
