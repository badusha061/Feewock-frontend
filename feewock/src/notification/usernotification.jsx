    ...
    <div className="mt-2 px-6 py-4 bg-white rounded-lg shadow w-full">
      <div className=" inline-flex items-center justify-between w-full">
        ...
        <div className="inline-flex items-center">
          ...
          <h3 className="font-bold text-base text-gray-800">Accepted</h3>
        </div>
      ...
      <p className="mt-1 text-sm">
        {data.action.appointment.name}, {data.action.appointment.location} ,{data.action.appointment.service_amount}, {data.action.appointment.service_time}
      </p>
    </div>
    ...
    <div className="mt-2 px-6 py-4 bg-white rounded-lg shadow w-full">
      <div className=" inline-flex items-center justify-between w-full">
        <div className="inline-flex items-center">
          ...
          <h3 className="font-bold text-base text-gray-800">Rejected</h3>
        </div>
        <p className="text-xs text-gray-500">
        {moment.utc(data.created_at).local().startOf('seconds').fromNow()}
        </p>
